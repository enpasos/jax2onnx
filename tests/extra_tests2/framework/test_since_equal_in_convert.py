...
def test_plugins2_since_metadata_present():
    """Every plugins2 primitive must carry a non-empty `since` marker."""
    ...
    assert not missing, (
        "plugins2 primitives must record a non-empty `since` metadata entry. "
