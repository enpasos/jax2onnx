...
PLUGINS_DIR = os.path.join(PROJECT_ROOT, "jax2onnx", "converter", "plugins")
...
def generate_test_classes(namespace):
    for (context, plugin), tests in get_tests_by_context_and_plugin().items():
        ...
        # Crucially, assign test_class to the provided namespace
