...
* `advanced_topics/onnx_ir_builder.md` – canonical builder guardrails and examples.
* `advanced_topics/expect_graph_reference.md` – structural test patterns for `expect_graph`.
* `advanced_topics/subgraph_input_handling.md` – control-flow body wiring (If/Loop/Scan).
* `../user_guide/supported_components.md` – autogenerated support matrices for primitives/examples.
* `../about/past_versions.md` – changelog snapshots for each jax2onnx release.
...
See `advanced_topics/expect_graph_reference.md` for a focused reference on writing
