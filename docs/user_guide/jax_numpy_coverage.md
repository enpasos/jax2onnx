...
| [x] | `linalg.solve` | `covered` | `jax/numpy/linalg_solve` | Direct plugin coverage via `jax_doc` or `component` metadata. |
...
| [x] | `linalg.tensorinv` | `covered` | `jax/numpy/linalg_tensorinv` | Direct plugin coverage via `jax_doc` or `component` metadata. |
...
| [x] | `nancumprod` | `covered` | `jax/numpy/nancumprod` | Direct plugin coverage via `jax_doc` or `component` metadata. |
