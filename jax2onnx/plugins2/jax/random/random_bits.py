# file: jax2onnx/plugins2/jax/random/random_bits.py
...
def _scalar_constant(ctx: "IRContext", value: float) -> ir.Value:
    from jax2onnx.converter2.ir_context import IRContext  # local import to avoid cycle
...
class RandomBitsPlugin(PrimitiveLeafPlugin):
    ...
    def lower(self, ctx, eqn):  # type: ignore[override]
        from jax2onnx.converter2.ir_context import IRContext  # local import
