...
class ClampPlugin(PrimitiveLeafPlugin):
    ...
    def to_onnx(
        ...
        min_name = _cast_to(s, min_name, mn_dt, x_dt, ctx="ClampMin", shape_hint=v_min.aval.shape)
        max_name = _cast_to(s, max_name, mx_dt, x_dt, ctx="ClampMax", shape_hint=v_max.aval.shape)
        ...
        z_name = out_name
        s.add_node(
            helper.make_node("Min", inputs=[y_name, max_name], outputs=[z_name],
