...
class TransformerDecoderLayer(nnx.Module):
    ...
    def __call__(self,
                 ...
                 *, deterministic: bool = True, decode=None) -> jax.Array:
...
class TransformerDecoder(nnx.Module):
    def __init__(self, num_layers: int, embed_dim: int, num_heads: int, ff_dim: int, *, rngs: nnx.Rngs, rate: float = 0.1, attention_dropout: float = 0.0, encoder_attention_dropout: float = 0.0, allow_residue: bool = True, deterministic: bool = True):
