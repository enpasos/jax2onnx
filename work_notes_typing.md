...
- ✅ Typed the remaining nn attention/activation shims (`nn.celu`, `nn.selu`, `nn.dot_product_attention`) so they reuse the shared lowering protocol and stay under strict mypy.
