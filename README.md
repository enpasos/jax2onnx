...
| ViT | A MNIST Vision Transformer (ViT) model | MNISTConvolutionalTokenEmbedding<br>TransformerBlock<br>flax.nnx.Linear<br>flax.nnx.LayerNorm | v0.1.0 | [`mnist_vit`](https://netron.app/?url=https://enpasos.github.io/jax2onnx/onnx/mnist_vit_model.onnx) ✅ |
