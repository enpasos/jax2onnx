...
See [`docs/coverage_tables.md`](docs/coverage_tables.md#supported-jaxonnx-components) for the full autogenerated support matrix, including links to every regression testcase.

---

## 🎯 Examples

See [`docs/coverage_tables.md`](docs/coverage_tables.md#examples) for the autogenerated examples catalog.
