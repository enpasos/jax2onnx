...
|:-------------|:---------------|:------|:----------------------------------------------------------------------------------------------------------------|
| [flax.nnx.BatchNorm](https://flax.readthedocs.io/en/latest/api_reference/flax.nnx/nn/normalization.html#flax.nnx.BatchNorm) | [BatchNormalization](https://onnx.ai/onnx/operators/onnx__BatchNormalization.html) | v0.1.0 | batchnorm ✅ [![onnx](https://enpasos.github.io/jax2onnx/images/netron.svg)](https://raw.githubusercontent.com/USERNAME/REPOSITORY/main/path/to/img.svg)
|
