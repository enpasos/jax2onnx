...
COVERAGE_PATH = BASE_DIR / "../docs/coverage_tables.md"
...
# Markers for auto-generated sections in docs/coverage_tables.md
...
def update_coverage_tables(
    ...
    """Updates docs/coverage_tables.md with new plugin and example tables."""
    plugins_grouped = {
    ...
    logging.info("✅ docs/coverage_tables.md updated successfully!")


def generate_markdown_table(
    grouped: dict[tuple[str, str], list[dict[str, Any]]], is_example: bool
) -> str:
    """Generates markdown table for docs/coverage_tables.md, ensuring all metadata is included."""
    if is_example:
        header = (
...
def replace_markers(
    ...
    """Replaces section between markers in docs/coverage_tables.md, ensuring no data loss."""
    start_idx = content.find(start_marker)
    end_idx = content.find(end_marker)
    if start_idx == -1 or end_idx == -1:
        logging.error(
            f"❌ Markers `{start_marker}` or `{end_marker}` not found in docs/coverage_tables.md"
        )
        return content
